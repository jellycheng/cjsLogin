...
class AlipayCore{
	...
	/**
	 * \CjsLogin\Zfb\AlipayCore::createLinkstring($param)
	...
	public static function charsetEncode($input,$_output_charset ,$_input_charset) {
		...
		if($_input_charset == $_output_charset || $input ==null ) {
			...
			die("sorry, you have no libs support for charset change, php mb_string ext.");
		}
		return $output;
	}
	/**
	...
	public static function charsetDecode($input,$_input_charset ,$_output_charset) {
		...
		if($_input_charset == $_output_charset || $input ==null ) {
			...
			die("sorry, you have no libs support for charset changes, php mb_string ext.");
		}
		return $output;
	}
